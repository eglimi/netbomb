...
void SpielfeldClient::setPlayer(int playerID, Position pos)
{
  ...
  cout << "PD2GUI::movePlayer(" << playerID+1 << ", " << direction << ", " << pos.x << ", " << pos.y << ")" << endl;
...
void SpielfeldClient::delPlayer(int playerID)
{
  ...
  //guiInterface->removePlayer(playerID+1);      <--------------------------
...
//  cout << "PD2GUI::setItem(" << item << ", " << pos.x << ", " << pos.y << ")" << endl;
...
void SpielfeldClient::explode(Position pos, int reichweite)
{
  ...
  cout << "PD2GUI::setItem(" << EXPLOSION << ", " << pos.x << ", " << pos.y << ")" << endl;
