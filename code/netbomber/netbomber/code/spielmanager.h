...
// Game variables
  ...
  bool              connected;                    // player is connected to the server
...
// network listening threads for server and client
  ...
  QMutex*           clientMutex;                   // mutex to stop the client thread

  QTimer*   clientTimer;  // test
public slots:
  void clientTimeout();
