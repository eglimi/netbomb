...
Der SpielManager ist f"ur die Initialisierung des Spiels zuständig. Er kennt alle Spieler und weitere f"ur das Spiel
...
\subsection{Mauer}
Die Mauer wird vor Spielbeginn erzeugt und bleibt w"ahrend des ganzen Spiels an ihrem Platz. Sie kann nicht zerst"ort werden, trotzt
