...
GameHandler::handleEvent(int fd, EventType eventType)
{
  if(eventType == READ_EVENT)
  {
    ...
    {
      NetworkManager::getNetworkManager()->informPD((char*)&buffer, m_playerNumber, nread);
    }
  }
  ...
  if(eventType == CLOSE_EVENT)
  {
    ...
    if(state == 0)
    {
      ...
      NetworkManager::getNetworkManager()->disconnect(m_playerNumber);
      delete this;
    }
  }
}
...
//    cout << "WriteToClient: "<< stringToWrite << endl;
  }
  return n;
}
